...
export class BannerList extends Component {
    ...
    componentWillMount() {
        this.props.getCitiesWithCountries();
    };
    ...
    render() {
        ...
        const { cities, currency,countries } = this.props;

        const items = cities.map(x => Object.assign(x, { flagUrl : countries[x.countryId].flagUrl }));
