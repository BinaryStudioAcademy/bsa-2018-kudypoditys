        ...
        <form onSubmit={props.handleSubmit}>
            <Container className="property_services_tab-container">
                <Segment className="property_services_tab-segment">
                    ...
                    <Segment
                        compact
                        className="property_services_tab-radio-segment"
                    >
                        <Radio
                            name="internet"
                            checked={internet === "free"}
                            value="free"
                            label="Yes, for free"
                    ...
                    >
                        <Radio
                            name="internet"
                            checked={internet === "additional"}
                            value="additional"
                            label="For additional fee"
                            onChange={handleChange}
                        />
                    </Segment>
                    <Segment
                    ...
                    {internet === "additional" ? (
                        <div className="property_services_tab-switched-segment">
                            ...
                            <Field
                                classname={"property_services_tab-input-error"}
                ...
                <Segment className="property_services_tab-segment">
                    ...
                    <Label>
                        This information is especially important to those who
                        travel by car.
                    </Label>
                            ...
                            <React.Fragment>
                                ...
                                <div>
                                    ...
                                    <Dropdown
                                        name="placement"
                                        onChange={handleParking}
                                        value={parking.placement}
                                        selection
                                        options={parkingOptions.placement}
                                    />
                                </div>
                                <div>
                                    <p>Booking</p>
                                    <Dropdown
                                        ...
                                        selection
                                        options={parkingOptions.booking}
                                    />
                                </div>
                                {parking.providing === "non_free" ? (
                                    <div>
                                        ...
                                        <Field
                                            classname={
                                                "property_services_tab-input-error"
                                            }
                                            component={InputPrice}
                                            label="USD"
                                            type="number"
                                            name="priceForDay"
                                            onChange={e =>
                                                handleParking(e, e.target)
                                            }
                                            pholder="0.00"
                                            val={parking.priceForDay}
                                            validate={[required]}
                                        />
                                    </div>
                                ) : null}
                ...
                <Segment className="property_services_tab-segment">
                    <Header as="h4">
                        Facilities and services popular with guests
                    </Header>
                    <Label>
                        guests are most often looking for exactly these
                    ...
                    {facilitiesOptions.map((facility, i) => (
                        <Segment
                            key={i}
                            compact
                            className="property_services_tab-checkbox-segment"
                        >
                            <Checkbox
            ...
            <Button
                fluid
                primary
                className="property_services_tab-continue-btn"
