...
storiesOf("QuickFilter", module)
    .add("QuickFilter with four boxes", () => <Quickfilter boxes={boxes1}/>)
    .add("QuickFilter with no amount", () => <Quickfilter boxes={boxes2}/>)
    .add("QuickFilter with no check", () => <Quickfilter boxes={boxes3}/>);
