...
// const rooms1 = {
//     rooms: [
//         {id:'1', type:'Standart Double room', bedsAmount: 1, sleeps:2, beds:'2 beds', info:'Our room is so amazing'},
//         {id:'2', type:'Carska Room', bedsAmount: 1,  sleeps:1, beds:'1 Carskiy bad', info:'Our room is so carska'},
//         {id:'3', type:'Obshchajna Room', bedsAmount: 3, beds:'4 Neudobnyh bad', sleeps:4,  info:'Our room is so obshchajna'},
//         {id:'4', type:'Polu Obshchajna Room', bedsAmount: 1, beds:'3 Neudobnyh bad',  sleeps:3, info:'Our room is almost obshchajna'}
//     ],
//     showRoomPrice(id){
//         console.log(id)
//     }
